...
public record TicketCommentPageRequest(
        int page,
        int size
) {
    ...
    public static TicketCommentPageRequest from(Integer page, Integer size) {
        ...
        return new TicketCommentPageRequest(resolvedPage, resolvedSize);
    }
}
