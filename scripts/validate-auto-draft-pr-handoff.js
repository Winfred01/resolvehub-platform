...
requireIncludes('"docs/portfolio-polish-roadmap"', "portfolio polish roadmap push filter");
...
assert(policy.isEligibleBranch("docs/portfolio-polish-roadmap"), "portfolio polish roadmap branch should be eligible");
...
assert(policy.titleForPortfolioPolishRoadmap("docs/portfolio-polish-roadmap") === "docs: add Portfolio Polish roadmap", "portfolio polish title should be specific");
assert(policy.titleForDocsBranch("docs/portfolio-polish-roadmap") === "docs: add Portfolio Polish roadmap", "docs branch title router should support portfolio polish roadmap");
...
assert(!policy.docsPrBody("docs/portfolio-polish-roadmap").includes("Closes #"), "portfolio polish PR body must not close issues");
...
console.log(JSON.stringify({
  ...
  checks: {
    ...
    portfolio_polish_has_no_issue_close: true,
