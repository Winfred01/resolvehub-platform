...
| #25 Analytics suggestions workflow integration | `V0_2_CORE` | 3 | Backend and frontend integration that displays suggestions, requires explicit accept/ignore/override action, handles analytics-service failures, and records safe review decisions. |
